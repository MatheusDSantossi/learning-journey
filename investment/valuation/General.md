O valuation (Avaliação de Empresas) é a ferramenta fundamental do Value Investing, a filosofia de investimento que busca diferenciar o preço de mercado do "valor" intrínseco de um ativo.

## O que é valuation

Para entender **o que é valuation** e **como montar um valuation** de uma empresa, é essencial dominar o vocabulário básico:

- Valor vs. Preço: O preço é o que paga no mercado hoje. O valor é o que você realmente leva, o potencial de geração de caixa futuro da empresa.
...
- Bancos de Investimento: Usam o **Valuation para precificar IPO**s (ofertas públicas iniciais), M&As (Fusões e Aquisições) e emissões de dívida.
...
## O novo cenário de juros e o impacto no WACC
...
Análise 2025: Empresas que prometem lucro "só para 2030" (as techs de alto crescimento - IA por exemplo) valem muito menos hoje, pois seus lucros distantes são descontados a uma taxa muito mais alta. O mercado agora dá um prêmio para empresas que geram caixa hoje (empresas de "Valor" e Dividendos)
...
Portanto, ao projetar o FCL, o analista DEVE usar uma alíquota efetiva de imposto maior do que a histórica. Assim o Fluxo de Caixa Livre (FCL) projetado para empresas que usavam o JCP (especialmente bancos, elétricas e saneamento) será menor do que seria no modelo antigo. **Modelos de Valuation** que não se ajustaram a isso estão superestimando o valor justo.
...
- A empresa A (Growth): O WACC alto "destruiu" o valor da perpetuidade. O valor presente dos lucros distantes caiu drasticamente, penalizando empresas que dependem de crescimento futuro.
...
Para saber **como calcular o valuation de uma empresa**, o investidor pode usar:

- Para o FDC: Site de RI da empresa (DFP, ITR), Apresentações de Resultados.

- Para o WACC: [Site do Tesouro Direto](https://www.tesourodireto.com.br/) (juro longo), dados do Prof. Damodaran (prêmio de risco).

- Para Múltiplos: Plataformas de dados ([Status Invest](https://statusinvest.com.br/), [Fundamentus](https://www.fundamentus.com.br/)).
...
- Usar um modelo de FDC antigo que não ajustou a alíquota de imposto pelo fim do JCP.
...
2. **O que é valor de mercado de uma empresa?**
...
4. **Qual a diferença entre valor de mercado de valor justo?**
