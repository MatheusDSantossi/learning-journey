...
![[inter_co_residual_income_valuation.html]]
...
![[inter_co_justified_pb_valuation.html]]

===========

![[inter_co_valuation_attack_bear_case.html]]
Here's the full intellectual case for the attack, grounded in live data:

**On the credit cycle.** Brazilian banks expect the system-wide default rate to remain at 5.1% in 2025 before rising marginally to 5.2% in 2026, with borrower stress not expected to decline meaningfully even as rate easing begins. This is the benign consensus — and it is already pricing in Inter's current NPL of 5.1%. At Banco do Brasil, the 90-day NPL ratio jumped to 4.93% in September 2025 from 3.33% a year earlier, and the cost of credit as a percentage of the loan portfolio rose to 5.16%. That's a state bank with mostly secured lending. Inter's unsecured consumer mix is structurally more sensitive. [Blogger](https://aswathdamodaran.blogspot.com/2025/07/)[Bvresources](https://www.bvresources.com/articles/bvwire/damodaran-updates-his-country-risk-analysis)

**On the growth-bank trap.** This is the most insidious bear-case mechanism. The perplexing concept of a 'growth bank' like Inter becomes a liability when the cycle starts to deteriorate, because management has to keep the market happy with growth, but this can only be done by adding risk at the worst possible time. The Central Bank started raising rates in September 2024 to a wait-and-see level of 15%, and because of lags, effects are only starting to be felt in credit costs, credit growth, and delinquencies. [Damodaran Online](https://pages.stern.nyu.edu/~adamodar/podcasts/valspr22/session5slides.pdf)

**On NIM sustainability.** Inter's funding strategy has a cost of funding at 9.8% — 67.7% of the CDI rate in Q4 2025 — and NIM 2.0 reached 9.57%. That spread is propped up by the Selic configuration. The 2025 annual report shows full-year NIM of 7.8% and an efficiency ratio of 46.4%, which is materially worse than the Q1 2026 headline figure of 43.8% — suggesting recent improvements may partly reflect methodology changes rather than structural transformation. [CompaniesMarketCap](https://companiesmarketcap.com/inter-co/marketcap/)[GuruFocus](https://www.gurufocus.com/economic_indicators/5893/brazil-total-equity-risk-premium)

**On regulation.** The BCB's regulatory package of September 2025 (Resolutions 494–498) was designed to reinforce the supervisory perimeter and raise baseline governance and control standards for players regarded as more exposed to operational and fraud risks within Brazil's financial system. Institutions with BaaS agreements executed prior to the resolution's effective date must achieve full compliance by 31 December 2026 — a hard cost and operational deadline. [Substack](https://aswathdamodaran.substack.com/p/country-risk-2025-the-story-behind)[Blogger](https://aswathdamodaran.blogspot.com/2025/07/country-risk-2025-story-behind-numbers.html)

**On the macro.** The Central Bank of Brazil raised its Selic rate by 50bp to 14.75% in May 2025, aiming to bring inflation closer to target, with market inflation forecasts for 2026 remaining above target at 4.5% per the FOCUS survey. Brazil's total credit growth decelerated to 10.2% YoY in December 2025, down from 11.5% in 2024, while Inter's loan book is growing at 33% — a gap that is only sustainable if Inter is capturing share from less efficient players and entering new credit segments. That is either the bull case or a red flag about underwriting standards. [GuruFocus](https://www.gurufocus.com/economic_indicators/5893/brazil-total-equity-risk-premium)[SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5168609)

**The honest bottom line:** At $6.30, you are paying for a base case that requires inter-dependent improvements in ROE, NIM, credit quality, and operating leverage — simultaneously — in a macro environment actively working against all four. The bear case is not a tail risk; it is a plausible central scenario. The model range of **$2.87–$8.50** for the base-to-bear span means the current price sits at a point where the risk/reward is asymmetric to the downside unless you have high conviction on Brazil's credit cycle normalising by 2027.